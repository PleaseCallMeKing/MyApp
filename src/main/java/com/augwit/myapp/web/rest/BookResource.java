...
import com.augwit.myapp.service.BookService;
...
import com.augwit.myapp.service.BookQueryService;
...
public class BookResource {
    ...
    @GetMapping("/books")
    @Timed
    public ResponseEntity<List<BookDTO>> getAllBooks(BookCriteria criteria,@ApiParam Pageable pageable) {
